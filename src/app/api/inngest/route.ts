...
import { newsletterEdition } from "@/inngest/functions/newsletter";

export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [dailyRunner, brandRunner, promptRunner, runJudge, brandScorer, publicScan, weeklyDigest, weeklyIndex, newsletterEdition],
});
