...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const fixed: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/methodologie`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/agences`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/badge`, lastModified, changeFrequency: "monthly", priority: 0.6 },
